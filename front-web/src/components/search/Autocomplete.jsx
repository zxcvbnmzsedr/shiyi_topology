...
export function Autocomplete({onSelect, queryNode, placeholder, ...props}) {
  const [searchText, setSearchText] = useState(null)
  const {data, run, loading} = useRequest(queryNode, {
    ...
    <div className="aa-Autocomplete">
      <form className="aa-Form">
        ...
        <div className="aa-InputWrapper">
          <Input onChange={handleQuery} autoFocus bordered={false} size={"large"} placeholder={placeholder} className="aa-Input"/>
        </div>
